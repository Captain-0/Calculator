...
class Calculator:
    ...
    def __init__(self, master):
        ...
        Button(width=11, height=4, text='1', relief='flat', bg='yellow', command=lambda: self.show('1')).place(x=0,
                                                                                                               y=125)
        Button(width=11, height=4, text='2', relief='flat', bg='yellow', command=lambda: self.show('2')).place(x=90,
                                                                                                               y=125)
        Button(width=11, height=4, text='3', relief='flat', bg='yellow', command=lambda: self.show('3')).place(x=180,
                                                                                                               y=125)
        Button(width=11, height=4, text='4', relief='flat', bg='yellow', command=lambda: self.show('4')).place(x=0,
                                                                                                               y=200)
        Button(width=11, height=4, text='5', relief='flat', bg='yellow', command=lambda: self.show('5')).place(x=90,
                                                                                                               y=200)
        Button(width=11, height=4, text='6', relief='flat', bg='yellow', command=lambda: self.show('6')).place(x=180,
                                                                                                               y=200)
        ...
        Button(width=11, height=4, text='/', relief='flat', bg='yellow', command=lambda: self.show('/')).place(x=270,
                                                                                                               y=50)
        Button(width=11, height=4, text='x', relief='flat', bg='yellow', command=lambda: self.show('*')).place(x=270,
                                                                                                               y=125)
